...
<div id="help"></div>
<div id="footer">
	<span class="item item-left"><a id="show-help" href="javascript:void(0)">查看帮助</a></span><span class="item item-center"><a href="https://github.com/zwchn">免费VR影院</a> © All Rights Reserved</span><span class="item item-right"><a href="javascript:void(0)" onclick="$('#advanced').slideToggle(200)">高级选项</a></span>
</div>
<!--百度收录自动推送-->
<script>
(function(){
