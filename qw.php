...
</div><p style="text-align: center;color: #F00;font-size: 10px;background: #eee;padding: 6px 2px;border-radius: 2px;">提示:下拉点击图标或者刷新页面可查看更多随机趣闻段子</p>
<!--直播开始-->
<script>
var w = '100%'; //宽度
var h = '2100'; //高度
var s = 'yes'; //是否显示滚动条，yes显示，no不显示
document.write('<iframe width='+w+' height='+h+' src="https://fun.html5.qq.com/?g=0" frameborder=0 border=0 marginwidth=0 marginheight=0 scrolling='+s+'></iframe>');
</script>
