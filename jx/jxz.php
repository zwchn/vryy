...
<div class="panel">
    <a href="javascript:QQ('http://yun.baiyug.cn/vip/index.php?url=<?php echo $_GET['url'];?>')">【A线】</a>
...
<div style="margin:-36px auto;width:100%;height:100%;">
    <iframe id="WANG" scrolling="no" allowtransparency="true" frameborder="0"
            src="http://yun.baiyug.cn/vip/index.php?url=<?php echo $_GET['url'];?>"width="100%" scrolling="no" height="100%" align="middle" frameborder="no" hspace="0" vspace="0" allowFullscreen="true" marginheight="0" marginwidth="0" name="tv"></iframe>
