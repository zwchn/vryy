...
</div><p style="text-align: center;color: #F00;font-size: 10px;background: #eee;padding: 6px 2px;border-radius: 2px;">提示:上下滑动查看详细天气预报</p>
<!--直播开始-->
<script>
var w = '100%'; //宽度
var h = '640'; //高度
var s = 'no'; //是否显示滚动条，yes显示，no不显示
document.write('<iframe width='+w+' height='+h+' src="http://weather.html5.qq.com" frameborder=0 border=0 marginwidth=0 marginheight=0 scrolling='+s+'></iframe>');
</script>
