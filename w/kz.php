...
<head>
	...
	<title><?php echo $aik['sitename'];?>手机在线导航大全</title>
...
<noscript><a href="http://www.51.la/?18759442" target="_blank"></a></noscript>
	...
	<div id="wrapper" class=""><!-- /wrapper -->
		<marquee style="border:solid 2px #a1d9f2;" direction="left"><span style="color:#009CDA; font-weight: bold;">公告：<?php echo $aik['sitename'];?>手机在线酷站平台，点击进入使用，无需任何安装APP，可在线体验功能。</span></marquee>
		<iframe id="calls" src="http://app.html5.qq.com/x5/index#~loop:svt=sort&columnId=36" width="100%" height="95%" style="position: absolute;top: 5%;"></iframe>
	</div><!-- /wrapper -->
	</body>
</html>
