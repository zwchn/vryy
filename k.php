...
</div><p style="text-align: center;color: #F00;font-size: 10px;background: #eee;padding: 6px 2px;border-radius: 2px;">提示:一直下拉视频会无限展示更多精彩视频或者刷新重新加载更新随机显示视频</p>
<!--直播开始-->

<iframe width="100%" height="1800" src="http://k.360kan.com/" frameborder=0 border=0 marginwidth=0 marginheight=0 scrolling='+s+'></iframe>

<!--<script>
var w = '100%'; //宽度
var h = '2000'; //高度
var s = 'yes'; //是否显示滚动条，yes显示，no不显示
document.write('<iframe width='+w+' height='+h+' src="http://k.360kan.com/pc/list" frameborder=0 border=0 marginwidth=0 marginheight=0 scrolling='+s+'></iframe>');
</script>
